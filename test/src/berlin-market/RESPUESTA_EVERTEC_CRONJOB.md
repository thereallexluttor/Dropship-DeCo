...
La sonda se ejecuta **cada 20 minutos** mediante un servicio externo de cron jobs.
...
2. **Sonda Periódica (Cronjob)**: Cada 20 minutos, mediante un servicio externo de cron jobs, el sistema ejecuta automáticamente una verificación de pagos pendientes que no han recibido notificación del webhook. Esto asegura que todos los pedidos se actualicen correctamente incluso en caso de problemas de conectividad.
...
- **Frecuencia**: Cada 20 minutos (mediante servicio externo de cron jobs)
