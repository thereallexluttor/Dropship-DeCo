...
La sonda se ejecuta **cada 10 minutos** (`*/10 * * * *`).
...
2. **Sonda Periódica (Cronjob)**: Cada 10 minutos, el sistema ejecuta automáticamente una verificación de pagos pendientes que no han recibido notificación del webhook. Esto asegura que todos los pedidos se actualicen correctamente incluso en caso de problemas de conectividad.
