      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <span className="inline-block mb-2 text-xs tracking-widest uppercase text-[#8B5A2B] font-medium">Newsletter</span>
            <h2 className="text-2xl md:text-3xl font-poppins text-[#1A1A1A] relative inline-block">
              <span className="relative z-10">Mantente Informado</span>
          ...
          <div className="max-w-md mx-auto">
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4">
              ...
              <button
                type="submit"
                className="px-8 py-3 bg-gradient-to-r from-[#8B5A2B] to-[#D7B377] text-white rounded-lg hover:opacity-90 transition-opacity duration-200 whitespace-nowrap"
              >
                Suscribirse
              </button>
            </form>
          ...
          <div className="mt-16 text-center">
            <span className="inline-block mb-2 text-xs tracking-widest uppercase text-[#8B5A2B] font-medium">Síguenos</span>
            <div className="flex justify-center gap-6 mt-4">
              <a href="#" className="text-gray-400 hover:text-[#8B5A2B] transition-colors duration-200">
