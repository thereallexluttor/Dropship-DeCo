...
export default function EdicionLimitada() {
  ...
  const imageEffects = {
    gold: "sepia(0.5) brightness(1.1)",
    platinum: "grayscale(0.5) brightness(1.2)",
    diamond: "brightness(1.3) contrast(1.1)",
  ...
  const categories = [
    {
      name: "COLECCIONES",
      description: "Descubre nuestras exclusivas colecciones de joyería",
      featured: {
        name: "Colección Royal",
        href: "/colecciones/royal",
        image: "/cap1.jpg"
      },
      items: [
        { 
          name: "Anillos", 
          href: "/anillos",
          description: "Anillos elegantes y atemporales",
          image: "/cap1.jpg"
        },
        { 
          name: "Collares", 
          href: "/collares",
          description: "Collares que destacan tu belleza",
          image: "/cap2.jpg"
        },
        { 
          name: "Pulseras", 
          href: "/pulseras",
          description: "Pulseras que cuentan tu historia",
          image: "/cap3.jpg"
        },
        { 
          name: "Pendientes", 
          href: "/pendientes",
          description: "Pendientes que brillan con luz propia",
          image: "/cap4.jpg"
        }
      ],
    },
    {
      name: "OCASIONES",
      description: "Joyas perfectas para cada momento especial",
      featured: {
        name: "Bodas",
      ...
      items: [
        { 
          name: "Bodas", 
          href: "/bodas",
          description: "Joyas para tu día más especial",
          image: "/cap1.jpg"
        },
        { 
          name: "Compromiso", 
          href: "/compromiso",
          description: "Anillos que simbolizan amor eterno",
          image: "/cap2.jpg"
        },
        { 
          name: "Regalos", 
          href: "/regalos",
          description: "Joyas que expresan sentimientos",
          image: "/cap3.jpg"
        },
        { 
          name: "Edición Limitada", 
          href: "/edicion-limitada",
          description: "Piezas únicas y exclusivas",
          image: "/cap4.jpg"
        }
      ],
    },
    {
      name: "MATERIALES",
      description: "Descubre la calidad de nuestros materiales",
      featured: {
        name: "Oro 18k",
        href: "/materiales/oro",
        image: "/cap3.jpg"
      ...
      items: [
        { 
          name: "Oro 18k", 
          href: "/materiales/oro",
          description: "La pureza del oro en su máxima expresión",
          image: "/cap1.jpg"
        },
        { 
          name: "Platino", 
          href: "/materiales/platino",
          description: "La elegancia del platino puro",
          image: "/cap2.jpg"
        },
        { 
          name: "Diamantes", 
          href: "/materiales/diamantes",
          description: "El brillo eterno de los diamantes",
          image: "/cap3.jpg"
        },
        { 
          name: "Piedras Preciosas", 
          href: "/materiales/piedras-preciosas",
          description: "La magia de las piedras preciosas",
          image: "/cap4.jpg"
        }
      ],
    },
    {
      name: "SERVICIOS",
      description: "Servicios exclusivos para tus joyas",
      featured: {
      ...
      items: [
        { 
          name: "Personalización", 
          href: "/servicios/personalizacion",
          description: "Crea tu joya única",
          image: "/cap1.jpg"
        },
        { 
          name: "Grabado", 
          href: "/servicios/grabado",
          description: "Añade un mensaje especial",
          image: "/cap2.jpg"
        },
        { 
          name: "Mantenimiento", 
          href: "/servicios/mantenimiento",
          description: "Cuida tus joyas como se merecen",
          image: "/cap3.jpg"
        },
        { 
          name: "Tasación", 
          href: "/servicios/tasacion",
          description: "Conoce el valor de tus joyas",
          image: "/cap4.jpg"
        }
      ],
    },
            ...
            <nav className="hidden md:flex space-x-6">
              {categories.map((category, index) => (
                ...
                >
                  ...
                  <div
                    className={`
                      absolute left-0 mt-2 w-[480px] rounded-lg shadow-xl bg-white ring-1 ring-black ring-opacity-5 
                      ...
                      <div className="relative h-32 mb-6 rounded-lg overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          <Link 
                            ...
                            className="text-white text-lg font-medium hover:text-[#C6A55C] transition-colors duration-300"
                          >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {category.items.map((item, itemIndex) => (
                          <Link
                            key={itemIndex}
                            href={item.href}
                            className="group/item flex items-start gap-3 p-2 rounded-lg hover:bg-gray-50 transition-colors duration-200"
                            role="menuitem"
                          >
                            <div className="relative w-16 h-16 rounded-md overflow-hidden flex-shrink-0">
                              <Image
                                ...
                                style={{
                                  filter: itemIndex % 4 === 0 ? imageEffects.gold :
                                         itemIndex % 4 === 1 ? imageEffects.platinum :
                                         itemIndex % 4 === 2 ? imageEffects.diamond :
                                         imageEffects.vintage
                                }}
                              />
                            </div>
                            <div>
                              <h3 className="text-sm font-medium text-gray-900 group-hover/item:text-[#C6A55C] transition-colors duration-300">
                                {item.name}
                              </h3>
                  ...
                  <div className="group relative">
                    ...
                    ">
                      ...
                      <Image
                        ...
                        alt={`Edición Limitada "Eternidad"`}
                        fill
