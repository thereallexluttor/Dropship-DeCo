...
const sampleProducts: Product[] = [
  {
    id: '1',
    name: 'Collar Diamante "Eterna Elegancia"',
    price: 3999,
  ...
  {
    id: '2',
    name: 'Gargantilla de Oro "Infinity"',
    price: 2499,
...
const imageEffects = {
  gold: "sepia(45%) hue-rotate(15deg) saturate(140%)",
  platinum: "brightness(108%) contrast(105%)",
  diamond: "brightness(115%) contrast(100%)",
  vintage: "sepia(35%) contrast(105%) brightness(95%)"
}
  ...
  return (
    <MainLayout>
      <div className="min-h-screen bg-white">
        ...
        <main>
                ...
                <div className="absolute inset-0">
                  {[1, 2, 3, 4].map((_, index) => (
                    ...
                    >
                      <Image
                        src={`/cap${index + 1}.jpg`}
                        alt={`Luxury Necklace Collection ${index + 1}`}
                        fill
                  ...
                  <div className="h-full w-full flex items-center justify-start relative z-10">
                    <div className="pl-8 md:pl-16 max-w-[95%] md:max-w-[70%] lg:max-w-[50%] space-y-3 md:space-y-5">
                      ...
                      <h1 className="text-base md:text-4xl lg:text-5xl font-poppins text-white leading-[1.4] md:leading-[1.5] tracking-wide drop-shadow-2xl">
                        <span className="block text-[#8B5A2B] font-light italic">Elegancia Natural</span>
                        <span className="block font-medium mt-2">Obras de Arte para Admirar</span>
                      </h1>
                      <p className="text-[9px] md:text-base lg:text-lg text-white/95 font-light tracking-[0.2em] uppercase font-poppins max-w-2xl">
                        Diseños orgánicos inspirados en la naturaleza
                      </p>
                  ...
                  <div className="md:w-2/5">
                    <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden rounded-3xl">
                      ...
                      <div className="absolute bottom-6 left-6 right-6">
                        <h3 className="text-white text-xl md:text-2xl font-light italic">Inspirados en la Naturaleza</h3>
                      </div>
                    </div>
                  </div>
                  <div className="md:w-3/5">
                    <h2 className="text-2xl md:text-3xl font-poppins text-[#1A1A1A] mb-4 relative inline-block">
                      <span className="relative z-10">Diseño Orgánico</span>
                    ...
                    <p className="text-gray-600 leading-relaxed my-6 font-light font-poppins">
                      Nuestros collares se inspiran en las formas y patrones de la naturaleza. Cada pieza captura la belleza orgánica y la fluidez de elementos naturales, transformados en joyas que celebran la elegancia intemporal.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="text-base font-medium mb-1 text-[#1A1A1A]">Piedras Seleccionadas</h3>
                          <p className="text-xs text-gray-600 leading-relaxed">
                            Gemas cuidadosamente elegidas por su color y pureza.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="text-base font-medium mb-1 text-[#1A1A1A]">Creación Artesanal</h3>
                          <p className="text-xs text-gray-600 leading-relaxed">
                            Elaborados a mano por artesanos con décadas de experiencia.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600 leading-relaxed">
                            Piezas cómodas y ligeras diseñadas para el uso diario.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="text-base font-medium mb-1 text-[#1A1A1A]">Sostenibilidad</h3>
                          <p className="text-xs text-gray-600 leading-relaxed">
                            Compromiso con prácticas éticas y materiales sostenibles.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="text-center mb-16">
              <span className="inline-block mb-2 text-xs tracking-widest uppercase text-[#8B5A2B] font-medium">Descubre</span>
              <h2 className="text-3xl font-poppins text-[#1A1A1A] mb-4 relative inline-block">
                ...
                <span className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 h-[3px] w-16 bg-gradient-to-r from-[#8B5A2B] to-[#D7B377]"></span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto font-light font-poppins mt-8">
                Piezas únicas que reflejan la belleza de la naturaleza y el arte de la joyería fina
              </p>
            </div>
                  ...
                  <div className="group relative">
                    ...
                    ">
                      ...
                      <Image
                        ...
                        alt={`Collar "${item % 2 === 0 ? 'Naturaleza Viva' : 'Aurora Dorada'}"`}
                        fill
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          <Link href="#" className="group/title">
                            <h3 className="text-sm font-medium text-gray-900 group-hover/title:text-[#8B5A2B] transition-colors duration-300">
                              Collar "{item % 2 === 0 ? 'Naturaleza Viva' : 'Aurora Dorada'}"
                            </h3>
                            <p className="text-xs text-gray-500">Colección {item % 3 === 0 ? 'Orgánica' : 'Botánica'}</p>
                          </Link>
                        </div>
                        <button 
                          className="
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center text-white">
              <FadeInOnScroll>
                ...
                <Link
                  href="/consulta"
                  className="group inline-flex items-center gap-2 bg-[#8B5A2B] text-white px-8 py-3 text-sm font-poppins tracking-wider hover:bg-white hover:text-black transition-all duration-300 relative overflow-hidden"
                >
                  ...
                  <div className="relative px-12">
                    ...
                    <div className="text-center">
                      <p className="text-lg italic mb-4">
                        "Una experiencia excepcional. El asesoramiento personalizado me ayudó a encontrar el collar perfecto para mi boda."
                      </p>
        ...
        {/* Footer */}
        <footer className="bg-black text-white py-16 mt-16 border-t border-[#8B5A2B]/20">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              ...
              <div className="md:col-span-1">
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.162-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.72-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.024 0 1.518.769 1.518 1.688 0 1.029-.653 2.567-.992 3.992-.285 1.193.6 2.165 1.775 2.165 2.128 0 3.768-2.245 3.768-5.487 0-2.861-2.063-4.869-5.008-4.869-3.41 0-5.409 2.562-5.409 5.199 0 1.033.394 2.143.889 2.741.099.12.112.225.085.345-.09.375-.293 1.199-.334 1.857-.334 1.857-.053.225-.172.271-.401.165-1.495-.69-2.433-2.878-2.433-4.646 0-3.776 2.748-7.252 7.92-7.252 4.158 0 7.392 2.967 7.392 6.923 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.354-.629-2.758-1.379l-.749 2.848c-.269 1.045-1.004 2.352-1.498 3.146 1.123.345 2.306.535 3.55.535 6.607 0 11.985-5.365 11.985-11.987C23.97 5.39 18.592.026 11.985.026L12.017 0z"/>
                    </svg>
                  </Link>
                </div>
              </div>
              ...
              <div>
                ...
                <form className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#8B5A2B] text-white px-6 py-2.5 text-sm font-medium hover:bg-[#7A4D22] transition-colors duration-300"
                  >
                    Suscribirse
                  </button>
                </form>
